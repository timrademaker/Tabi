...
namespace tabi
{
    ...
    public:
        ...
        tabi::shared_ptr<T> LoadResource(const char* a_ResourcePath, Args... a_Args);
    ...
    inline tabi::shared_ptr<T> ResourceManager::LoadResource(const char* a_ResourcePath, Args ...a_Args)
    {
        ...
        auto id = tabi::utils::CalculateResourceID(a_ResourcePath);
        ...
        {
            // Load resource
            tabi::shared_ptr<T> resource = tabi::make_shared<T>(a_ResourcePath, tabi::forward<Args>(a_Args)...);
