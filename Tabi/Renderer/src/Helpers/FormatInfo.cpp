...
namespace tabi
{
    ...
    public:
        FormatInfoTable()
        {
            ...
            Add(EFormat::RGBA16_unorm,      { true,      8,    4,    EDataType::Ushort  });
            Add(EFormat::RGBA16_snorm,      { true,      8,    4,    EDataType::Short   });
            Add(EFormat::RGBA16_uint,       { false,     8,    4,    EDataType::Ushort  });
            Add(EFormat::RGBA16_sint,       { false,     8,    4,    EDataType::Short   });
            Add(EFormat::RGB16_float,       { false,     6,    4,    EDataType::Float   });
            Add(EFormat::RGB16_unorm,       { true,      6,    3,    EDataType::Ushort  });
            Add(EFormat::RGB16_snorm,       { true,      6,    3,    EDataType::Short   });
            Add(EFormat::RGB16_uint,        { false,     6,    3,    EDataType::Ushort  });
            Add(EFormat::RGB16_sint,        { false,     6,    3,    EDataType::Short   });
            Add(EFormat::RG16_float,        { false,     4,    2,    EDataType::Float   });
            Add(EFormat::RG16_unorm,        { true,      4,    2,    EDataType::Ushort  });
            Add(EFormat::RG16_snorm,        { true,      4,    2,    EDataType::Short   });
            Add(EFormat::RG16_uint,         { false,     4,    2,    EDataType::Ushort  });
            Add(EFormat::RG16_sint,         { false,     4,    2,    EDataType::Short   });
            Add(EFormat::R16_float,         { false,     2,    1,    EDataType::Float   });
            Add(EFormat::R16_unorm,         { true,      2,    1,    EDataType::Ushort  });
            Add(EFormat::R16_snorm,         { true,      2,    1,    EDataType::Short   });
            Add(EFormat::R16_uint,          { false,     2,    1,    EDataType::Ushort  });
            Add(EFormat::R16_sint,          { false,     2,    1,    EDataType::Short   });
